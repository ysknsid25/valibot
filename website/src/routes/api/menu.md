...
- [ipv6](/api/ipv6/)
- [isbn](/api/isbn/)
- [isoCountryCode](/api/isoCountryCode/)
- [isoCurrencyCode](/api/isoCurrencyCode/)
- [isoDate](/api/isoDate/)
...
- [IsoCountryCodeAction](/api/IsoCountryCodeAction)
- [IsoCountryCodeIssue](/api/IsoCountryCodeIssue)
- [IsoCurrencyCodeAction](/api/IsoCurrencyCodeAction)
- [IsoCurrencyCodeIssue](/api/IsoCurrencyCodeIssue)
